...
export const ABOUT = {
  story: [
    ...
    "Базирани сме във Варна и работим с клиенти от цяла България и Европа. Нашият подход е инженерен: анализираме проблема, проектираме решението, изграждаме го с модерен tech stack и мерим ROI. Без PowerPoint презентации — само работещ код и реални метрики.",
