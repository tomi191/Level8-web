...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    technicalDecisions: [
      ...
      {
        question: "Астрономическите изчисления — вътре в приложението или на отделен сървър?",
        chose: "Вградено астрономическо ядро в същото приложение",
        rejected: [
          "Отделен сървър за астрономически изчисления (Python)",
      ...
      {
        question: "Облачна база данни или самостоятелен сървър?",
        chose: "Облачен Postgres с вградена защита на ниво ред",
        rejected: ["Самостоятелен Postgres + отделен сървис за автентикация", "Комбинация от няколко доставчика"],
        reasoning:
